...
export default function Authenticity() {
  ...
  //     const tx = await sContract.manufacturerRegisters(
  //       manufacturerAddress,
  //       manufacturerName
  //     );
  //     await tx.wait();
  ...
  //       toast.error("Error: Manufacturer address cannot be zero");
  //     } else if (parsedError.includes("ALREADY_REGISTERED")) {
  //       toast.error("Error: Manufacturer already registered");
  //     } else if (parsedError.includes("INVALID_MANUFACTURER_NAME")) {
  //       toast.error("Error: Invalid manufacturer name");
  //     } else if (parsedError.includes("NAME_NOT_AVAILABLE")) {
  //       toast.error("Error: Manufacturer name not available");
  //     } else if (parsedError.includes("ONLY_OWNER")) {
  //       toast.error("Error: Only contract owner can register manufacturers");
  //     } else {
  //       // toast.error(`Error: ${parsedError}`);
  //       toast.error(`Error: ${error.message}`); //some other error that is not parsed
  //     }
  //   }
  // };
